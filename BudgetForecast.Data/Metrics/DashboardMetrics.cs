...
namespace BudgetForecast.Data.Models.Metrics
{
    public class DashboardMetrics
    {
        ...
        public DashboardMetrics()
        {
            ...
            MandatoryExpensesByMonth = new Dictionary<string, decimal>();
            DiscretionarySpendingByMonth = new Dictionary<string, decimal>();
            CashFlowByMonth = new Dictionary<string, decimal>();
        }
